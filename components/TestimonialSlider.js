...
const TestimonialSlider = () => {
  return (
    <Swiper
      ...
      className='h-[400px]'
    >
      {testimonialData.map((personItem, personItemIndex) => (
        <SwiperSlide key={personItemIndex}>
          <div className='flex flex-col items-center md:flex-row gap-x-8 h-full px-16'>
            ...
            items-center relative mx-auto xl:mx-0'>
              <div className='flex flex-col justify-center text-center'>
                ...
                <div className='text-lg'>{personItem.name}</div>
            ...
            <div className='flex flex-1 flex-col justify-center
             ...
             xl:before:h-[200px] relative xl:pl-20'>
              ...
              <div className='xl:text-lg text-center md:text-left'>{personItem.message}</div>
            </div>
          </div>
        </SwiperSlide>
      ))}
